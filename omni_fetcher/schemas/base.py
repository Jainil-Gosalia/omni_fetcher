...
class FetchMetadata(BaseModel):
    ...
    source_uri: str = Field(..., description="Original URI of the fetched resource")
    fetched_at: datetime = Field(default_factory=datetime.now, description="Timestamp when resource was fetched")
    ...
    fetch_duration_ms: Optional[float] = Field(None, ge=0, description="Time taken to fetch in milliseconds")
